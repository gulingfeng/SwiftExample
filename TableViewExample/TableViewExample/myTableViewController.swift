...
class myTableViewController: UITableViewController {
    ...
    var myData = ["apple","orange","grap","pear","banana"]
    override func viewDidLoad() {
        ...
        for subview in self.view.subviews
        {
            ...
            {
                println("subview: \(subview.isKindOfClass(UITableView))")
                var a = subview as UITableView
                let temp = a.frame
                a.frame = CGRect(x: temp.minX, y: temp.minY, width: temp.width, height: 50)
